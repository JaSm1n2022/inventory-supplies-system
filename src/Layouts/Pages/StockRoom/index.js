  ...
  return (
    <React.Fragment>
      ...
      <Grid container spacing={24} justify="space-between">
          <div>
          <Typography variant="h4">Stock Room Inventory</Typography>
          </div>
          <div>
      ...
      {isFormModal &&
        <StockForm productList={productList} dataSource={dataSource} createStockHandler={createStockHandler} mode={mode} isOpen={isFormModal} isEdit={false} item={item} onClose={closeFormModalHandler} />
      }
    </React.Fragment>
  )
}
