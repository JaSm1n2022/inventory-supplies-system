...
const OfficeExpensesReport = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            <Grid justifyContent="space-between" container style={{ padding: 10 }}>
                <Typography variant="body1" color="textSecondary">*** This report is based on reported product as office category ***</Typography>
            </Grid>
...
export default connect(mapStateToProps, mapDispatchToProps)(OfficeExpensesReport);
