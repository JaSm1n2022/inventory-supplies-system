...
export const QUANTITY_UOM = ["Carton", "Box", "Case", "Pack", "Pcs", "Bag"];
...
export const THRESHOLD_CATEGORY = [
  {
    categoryType: "thresholdCategory",
    category: "brief",
    default: 40,
    name: "brief",
    label: "brief",
  ...
  {
    categoryType: "thresholdCategory",
    category: "ensure vanilla",
    name: "ensure vanilla",
    label: "ensure vanilla",
    value: "ensure vanilla",
    default: 14,
  },
  {
    categoryType: "thresholdCategory",
    category: "ensure chocolate",
    name: "ensure chocolate",
    label: "ensure chocolate",
    value: "ensure chocolate",
    default: 14,
  },
  {
    categoryType: "thresholdCategory",
    category: "ensure strawberry",
    name: "ensure strawberry",
    label: "ensure strawberry",
    value: "ensure strawberry",
    default: 14,
  },
];
